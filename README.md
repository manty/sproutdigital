...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/manty/sproutdigital)

### Option 2: Local Development

```bash
# Clone the repo
git clone https://github.com/manty/sproutdigital.git
cd sproutdigital
